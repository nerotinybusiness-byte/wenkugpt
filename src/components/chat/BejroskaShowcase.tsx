...
const BEJROSKA_PRIMARY_MODEL_SRC = '/models/bejroska-hoodie-external.gltf?v=2026-02-12-external-1';
const BEJROSKA_FALLBACK_MODEL_SRC = '/models/bejroska-hoodie-fast-png.glb?v=2026-02-12-external-1';
